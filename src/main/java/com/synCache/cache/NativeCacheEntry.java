...
public class NativeCacheEntry implements AutoCloseable {
    ...
    public NativeCacheEntry(String nameSpace, String id, String value, Long ttlSecondsOrNull) {
        this.nativeHandle = nCreate(nameSpace, id, value, ttlSecondsOrNull);
    }
    ...
    private static native long nCreate(String nameSpace, String id, String value, Long ttlSecondsOrNull);
