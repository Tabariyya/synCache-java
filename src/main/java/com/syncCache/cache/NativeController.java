...
public class NativeController implements AutoCloseable {
    ...
    public void set(NativeCacheEntry entry, Long ttlSecondsOrNull) {
        nSet(nativeHandle, entry.handle(), ttlSecondsOrNull);
    }
    ...
    private static native void nSet(long controllerHandle, long entryHandle, Long ttlSecondsOrNull);
